    ...
    <div class="panel-body">
        <div class="well">
            ...
            <form class="form-inline" action="<?= url('/user/delete') ?>" method="POST">
                <input type="hidden" name="token" value="<?= $token; ?>">
                <input type="hidden" name="id" value="<?= $_SESSION['user_id']; ?>">
                <div class="row"><div class="col-xs-7"><span class="help-block bg-danger">THIS WILL PERMANENTLY DELETE YOUR ACCOUNT AND ALL GAMES ASSOCIATED WITH IT!</span></div></div>
